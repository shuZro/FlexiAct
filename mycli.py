...
if __name__ == "__main__":
    gt_img_path = "benchmark/target_images/human/game_girl_1.webp"
    prompt = '''A woman is performing a fitness exercise. She clasps her hands together, \
    ...
    emb_ckpt_path = "ckpts/FAE/motion_ckpts/rotation.pt"
    gt_img = get_gt_img(gt_img_path, 480, 720)
    generate_video(
        prompt=prompt,
        pretrained_model_name_or_path=pretrained_model_name_or_path,
        refadapter_ckpt_path=refadapter_ckpt_path,
